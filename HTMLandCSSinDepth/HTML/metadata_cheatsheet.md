...
```<meta name="description"/>``` provides a brief description of the web page <br>

```<meta name=”title”/>``` specifies the title of the web page <br>

```<meta name="author" content="name">``` specifies the author of the web page  <br>

```<meta name="language" content="english">``` specifies the language of the web page <br>


```<meta name="robots" content="index,follow" /```> tells search engines how to crawl or index a certain page <br>
